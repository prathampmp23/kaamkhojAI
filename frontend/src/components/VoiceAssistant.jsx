...
const VoiceAssistant = ({
  ...
  const processText = async (text) => {
    try {
      ...
      const response = await axios.post(
        "https://kaamkhojaibackend.onrender.com/api/voice/process",
        {
          text,
          lang: language,
          fieldType,
  ...
  const detectFieldType = (text) => {
    ...
    if (
      ...
      lowerText.includes("लिंग") ||
      lowerText.includes("पुरुष") ||
      lowerText.includes("महिला")
    ) {
      return "gender";
    }
    ...
    if (
      ...
      lowerText.includes("उम्र") ||
      lowerText.includes("साल")
    ) {
      return "age";
    }
    ...
    if (
      ...
      lowerText.includes("पता") ||
      lowerText.includes("निवास")
    ) {
      return "address";
    }
    ...
    if (
      ...
      lowerText.includes("अनुभव") ||
      lowerText.includes("काम किया")
    ) {
    ...
    if (
      ...
      lowerText.includes("good at") ||
      lowerText.includes("कौशल") ||
      ...
      {extractedData && extractedData.success && (
        <div className="extracted-data-container">
          ...
          <div className="extracted-value">
            <strong>{extractedData.field || "Value"}:</strong>{" "}
